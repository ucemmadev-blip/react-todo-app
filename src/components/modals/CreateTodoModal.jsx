...
function CreateTodoModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
      <div className="bg-white w-200  p-6 rounded-2xl">
        ...
        <div className="flex gap-4 justify-center">
          <textarea
            ...
            onChange={handleChange}
            className="w-full border p-3 rounded-lg mb-5 h-32"
          />
          <div className="">
            <div className="border-2 border-dashed border-gray-300 rounded-2xl p-6 bg-gray-50 flex flex-col items-center justify-center text-center">
